...
test('should throw on unknown function name with correct service', (t) => {
  ...
  t.is(
    error.message,
    'Unknown method saySomething for service helloworld.Greeter',
  )
})
...
test('should add handler for consecutive upper case', (t) => {
  ...
  t.truthy(
    app.data['acmecorp.greeter.v1.Greeter2'].handlers[
      '/acmecorp.greeter.v1.Greeter2/GetFOOBar'
    ],
  )
  t.true(
    Array.isArray(
...
test('should add handler using service name and function', (t) => {
  ...
  t.is(
    app.data['helloworld.Greeter'].handlers['/helloworld.Greeter/SayHello'][0],
    handler,
  )
})
...
test('should throw on duplicate handlers', (t) => {
  ...
  t.is(
    error.message,
    'Handler for sayHello already defined for service helloworld.Greeter',
  )
})
...
test('should add handler and middleware when set using name', (t) => {
  ...
  t.is(
    app.data['helloworld.Greeter'].handlers['/helloworld.Greeter/SayHello'][1],
    handler,
  )
})
...
test('should add global middleware and handler and middleware', (t) => {
  ...
  t.is(
    app.data['helloworld.Greeter'].handlers['/helloworld.Greeter/SayHello'][2],
    handler,
  )
})
...
test('multi: should add handler using object notation specifying service', (t) => {
  ...
  t.is(_.keys(app.data['helloworld.Greeter'].handlers).length, 1)
  t.truthy(
    app.data['helloworld.Greeter2'].handlers['/helloworld.Greeter2/SayHello'],
  )
...
test('multi: should throw on duplicate handlers using multimple services', (t) => {
  ...
  t.is(
    error.message,
    'Handler for sayHello already defined for service helloworld.Greeter2',
  )
})
...
test('multi: should add handler and middleware when set using service name and function name', (t) => {
  ...
  t.is(
    app.data['helloworld.Greeter2'].handlers[
...
test('multi: should add handler and middleware when set using service name and function name 2', (t) => {
  ...
  t.truthy(
    app.data['helloworld.Greeter4'].handlers['/helloworld.Greeter4/SayGoodbye'],
  )
  t.true(
    Array.isArray(
      app.data['helloworld.Greeter4'].handlers[
        '/helloworld.Greeter4/SayGoodbye'
      ],
    ),
  )
  t.is(
...
test('multi: should add global middleware to all services after the global use', (t) => {
  ...
  t.truthy(
    app.data['helloworld.Greeter4'].handlers['/helloworld.Greeter4/SayHello'],
  )
  t.true(
    Array.isArray(
      app.data['helloworld.Greeter4'].handlers['/helloworld.Greeter4/SayHello'],
...
test('multi: should add handlers using object notation for all services with global middleware', (t) => {
  ...
  t.truthy(
    app.data['helloworld.Greeter3'].handlers['/helloworld.Greeter3/SayGoodbye'],
  )
  t.true(
    Array.isArray(
      app.data['helloworld.Greeter3'].handlers[
        '/helloworld.Greeter3/SayGoodbye'
      ],
    ),
  )
  t.is(
...
test('should add multiple middleware if just functions passed to use()', (t) => {
  ...
  t.is(
    app.data['helloworld.Greeter'].handlers['/helloworld.Greeter/SayHello'][3],
    handler,
  )
})
